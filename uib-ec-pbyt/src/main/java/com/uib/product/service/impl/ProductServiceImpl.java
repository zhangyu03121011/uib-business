...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public Product queryProductByProductId(String productId,String rankId) throws Exception {
		//TODO 获取当前登录用户的bankID 
		//FIXME zfan
//		String bankId = "1";
		Product product = productServiceDao.queryProductByProductId(productId, rankId);
	...
	public Product findById(String productId,String rankId) {
		...
		//FIXME zfan
		 //rankId = "1";
		return productServiceDao.queryProductByProductId(productId, rankId);
	}
	...
	@Override
	public void updateAllocatedStockBatch(List<ParamBean> params, OperationType operationType) throws Exception {
		productServiceDao.updateAllocatedStockBatch(params, operationType);
	}
