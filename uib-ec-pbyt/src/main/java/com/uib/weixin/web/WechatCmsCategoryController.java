...
@Controller
@RequestMapping("/wechat/CmsCategory")
public class WechatCmsCategoryController {
	private Logger logger = LoggerFactory.getLogger(WechatCmsCategoryController.class);
