...
public class CartInfo4Wechat {
	...
	private String productType;    //1.C端用户商品 2.B端用户推广的商品
	private boolean wxIsPriceChanged;//判断商品价格是否已变动
	...
	public boolean isWxIsPriceChanged() {
		return wxIsPriceChanged;
	}
	public void setWxIsPriceChanged(boolean wxIsPriceChanged) {
		this.wxIsPriceChanged = wxIsPriceChanged;
	}
}
