...
(function($,win,undef){
	...
	Validform.util={
		dataType:{
			"match":/^(.+?)(\d+)-(\d+)$/,
			"*":/[\w\W]+/, //非空
			"*6-16":/^[\w\W]{6,16}$/, //6至16位任意字符
			"n":/^\d+$/, //数字类型
			"n6-16":/^\d{6,16}$/, //6至16位数字
			"s":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]+$/, //字符串类型
		...
		check:function(curform,brothers,subpost,bool){
			...
			*/
			...
			this.validform_lastval=null;//存储当前值;
	...
	function creatMsgbox(){
		...
		msgobj=$('<div id="Validform_msg"><div class="Validform_title">'+tipmsg.tit+'<a class="Validform_close" href="#">&chi;</a></div><div class="Validform_info"></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body");//提示信息框;
