		...
		success: function(cart){
			...
			if(cart!=null&&cart.cartItems!=null){
				...
				$.each(cart.cartItems,function(indec,cartItem){
					cart_item_html += "<dt><a href=\"#\"><img src=\"../showImage?filePath="+(cartItem.product.image==null?"123":cartItem.product.image)+"\" /></a>"+
					  "<p>"+
        ...
        <div class="tool_link">
        			<c:choose>
						<c:when test="${not empty(member)}">
							${member.username},欢迎您光临初云汇商城！  &nbsp;&nbsp; <a href="${pageContext.request.contextPath  }/f/logout">退出</a>
						</c:when>
						<c:otherwise>
            ...
            <li class="user menu-item">
				  <div class="menu"><span class="menu-hd"><s></s>我的账户<b></b></span> 
					  <div class="menu-bd">
						<div class="menu-bd-panel">
						  <ul>
                          <li> <a href="${pageContext.request.contextPath  }/f/member/myOrder?orderStatus=4">我的订单</a></li>
                          <!-- <li> <a href="#">地址管理</a></li> -->
                          </ul>
						  </div>	  
					  </div>
              ...
              <li class="cart menu-item">
				  <div class="menu"><span class="menu-hd"><s></s>购物车(<font id="font_of_cart_count">0</font>)<b></b></span> 
...
<!-- 菜单栏开始 -->
<div class="navWrap">
<div class="navsort w980">
	<div class='allsort'>
		<div class='mt'><s></s><font>全部分类</font><div class='extra'>&nbsp;</div></div>
		<div class='mc'>
