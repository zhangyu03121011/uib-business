...
$(function(){
		...
		$('.close,pop_btn pop_cancel ml20').click(function(){
...
<p class="font18 green">订单已提交成功，请尽快完成付款！</p>
...
<!-- 银行卡内容 -->
<form action="${pageContext.request.contextPath}/f/pay/unionPay" id="inputForm" target="_bank" method="post">
<div id="con_one_1">
<h3>请选择银行（需开通网银）</h3>
<ul>
<li>
...
<input  type="hidden" name="goodsName" value="${orderNo }"/>
<input name="pay" type="radio" value="chinaBank" />
<img src="${pageContext.request.contextPath}/static/images/bank01.gif" alt="中国银行"/>
</label>
</li>
</ul>
<div class="orderpayment_btn"><a class="orderpayment_btnbox font18">下一步</a></div>
</div>
<!-- 平台支付 -->
...
<li>
<label>
<input name="pay" type="radio" value="easypay" />
...
<li>
<label>
<input name="pay" type="radio" value="yl" />
...
<img src="${pageContext.request.contextPath}/static/images/alipay.png"  alt="支付宝"/>
</label>
</li>
</ul>
<div class="orderpayment_btn"><a class="orderpayment_btnbox font18" href="javascript:void(0)" onclick="doSubmit()">立即付款</a></div>
</div>
</form>
</div>
</div>
...
<!-- 弹出框 -->
		...
		<div class="pop_btnbox"><a class="pop_btn pop_confirm" href="${pageContext.request.contextPath}/f/member/myOrder" >已完成支付</a><a class="pop_btn pop_cancel ml20" href="javascript:;" >支付遇到问题</a></div>
		</div>
	     </div>
