...
public class DigestUtil {
	...
	public static void main(String[] args) {
		//47da9f8ddad8aca50bb32efa6e721e7d

		System.out.println(DigestUtil.MD5("123456"));
		
		// 生成一个DES算法的密匙  
        SecretKey key = DigestUtil.createSecretKey("DES");  
        
     // 用密匙加密信息"Hello world!"  
        String str1 = DigestUtil.encryptToDES(key, "Hello");  
        System.out.println("使用des加密信息Hello为:" + str1);  
        // 使用这个密匙解密  
        String str2 = DigestUtil.decryptByDES(key, str1);  
        System.out.println("解密后为：" + str2);  
        
        
        // 创建公匙和私匙  
        DigestUtil.createPairKey();  
        // 对Hello world!使用私匙进行签名  
        DigestUtil.signToInfo("Hello", "mysign.bat");  
        // 利用公匙对签名进行验证。  
        if (DigestUtil.validateSign("mysign.bat")) {  
