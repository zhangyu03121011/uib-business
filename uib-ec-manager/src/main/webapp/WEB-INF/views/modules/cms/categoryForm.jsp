...
<head>
	...
	<script type="text/javascript">
		...
		function isCmsCategoryNo(){
			var cmsCategoryNo = $("#cmsCategoryNo").val();
				$.ajax({
					cache:false,
					type:"post",
					url:"${ctx}/cms/category/checkCmsCategoryNo",
					data:{cmsCategoryNo:cmsCategoryNo},
					dataType :'json',
					success:function(data){
						if(!data.status){
							$("#isCmsCategoryNo").text("已经添加");
						}
					}
				});
			}
...
<body>
	...
	<form:form id="inputForm" modelAttribute="category" action="${ctx}/cms/category/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="cmsCategoryNo" htmlEscape="false" maxlength="32" class="required" onchange="isCmsCategoryNo()"/>
				<font color="#EA5200" style="font-weight: bold;"><span id="isCmsCategoryNo"></span></font>
			</div>
		</div>
		<div class="control-group">
