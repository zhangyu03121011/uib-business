...
<head>
	...
	KindEditor.ready(function(K) {
		K.create('textarea[name="articleData.content"]', {
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
             ...
             <%--    <input type="text" id="image" name="image" value="${article.imageSrc}" />    --%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea id="editor"  htmlEscape="true" path="articleData.content" rows="4" maxlength="200" class="editor"/>
