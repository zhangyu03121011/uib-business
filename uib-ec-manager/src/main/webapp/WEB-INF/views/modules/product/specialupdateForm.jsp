...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/product/special/updateFormView?id=${product.specialId}">专题基本信息</a></li>
	...
	<form:form id="inputForm" modelAttribute="special" action="${ctx}/product/special/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
