...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/product/propertyGroup/">商品属性</a></li>
	...
	<form:form id="inputForm" modelAttribute="propertyGroup" action="${ctx}/product/propertyGroup/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
