...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/product/special/updateFormView?id=${product.specialId}">专题信息修改</a></li>
	</ul><br/>
	<ul class="nav nav-tabs">
		<li>
			<a href="${ctx}/product/special/updateFormView?id=${product.specialId}&updateFlag=${product.updateFlag}">专题基本信息</a>
		</li>
		<li><a href="${ctx}/product/special/updateSelectProduct?specialId=${product.specialId}&updateFlag=${product.updateFlag}">专题商品查看</a></li>
		<c:choose>
			<c:when test="${product.specialId!=null && not empty product.specialId}">
			<li class="active"><a href="${ctx}/product/special/updateProductList?specialId=${product.specialId}&updateFlag=${product.updateFlag}">专题商品添加</a></li>
			</c:when>
			<c:otherwise>
	...
	<form:form id="searchForm" modelAttribute="product" action="${ctx}/product/special/updateProductList" method="post" class="breadcrumb form-search">
	...
	<form:form id="inputForm" action="${ctx}/product/special/updateAddProduct" method="post" class="breadcrumb form-search">
