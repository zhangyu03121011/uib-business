...
<head>
	...
	<script type="text/javascript">
		...
		function ajaxFileUpload(domId) {
			//$("#uploadId").ajaxStart(function() {
			//	$(this).show();
			//}).ajaxComplete(function() {
			//	$(this).hide();
			//});
			$('#productSpecificationList tr td input[type="button"]').each(function(){
				console.info($(this).val());
			});
			console.info($("#"+domId).prop('files')[0]);
			$.ajaxFileUpload({
				url : '../../image/upload/20150615/123',// servlet请求路径
				secureuri : false,
				fileElementId : domId,// 上传控件的id
				dataType : 'json',
				data : $("#"+domId).prop('files')[0], // 其它请求参数
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/product/specificationGroup/">商品规格</a></li>
	...
	<form:form id="inputForm" modelAttribute="specificationGroup" action="${ctx}/product/specificationGroup/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
