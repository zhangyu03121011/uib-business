...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/order/orderTableRefunds/form?id=${orderTableRefunds.id}">退款单<shiro:hasPermission name="order:orderTableRefunds:edit">${not empty orderTableRefunds.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="order:orderTableRefunds:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="orderTableRefunds" action="${ctx}/order/orderTableRefunds/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="orderTable.id" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
