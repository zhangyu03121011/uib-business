...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${pageContext.request.contextPath  }/a/ad/advertisement/updateFormView?id=${advertisement.id}">广告管理<shiro:hasPermission name="ad:advertisement:edit">${not empty advertisement.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ad:advertisement:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="advertisement" action="${pageContext.request.contextPath  }/a/ad/advertisement/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:choose>
			<c:when test="${advertisement.type==0}">
				...
				<div class="control-group" style="display:none" id="ad_path_div">
			...
			<c:otherwise>
				<div class="control-group" id="ad_content_div" style="display:none">
					<label class="control-label">内容：</label>
					<div class="controls">
						<form:textarea path="content" htmlEscape="false" rows="4" class="input-xxlarge "/>
					</div>
				</div>
				<div class="control-group" id="ad_path_div">
					<label class="control-label">路径：</label>
					<div class="controls">
						<form:input path="path" htmlEscape="false" maxlength="255" class="input-xlarge "/>
						<input id="file_select_button" type="button" value="选择图片"/>
				...
				<div class="control-group" id="app_ad_path_div">
					<label class="control-label">APP路径：</label>
					<div class="controls">
						<form:input path="appPath" htmlEscape="false" maxlength="255" class="input-xlarge "/>
						<input id="app_file_select_button" type="button" value="选择图片"/>
				...
				<div class="control-group" id="app_ad_url">
					<label class="control-label">APP链接地址：</label>
					<div class="controls">
						<form:input path="appUrl" htmlEscape="false" maxlength="255" class="input-xlarge "/>
					</div>
				</div>
				<div class="control-group" id="wx_ad_path_div">
					<label class="control-label">微信路径：</label>
					<div class="controls">
						<form:input path="wxPath" htmlEscape="false" maxlength="255" class="input-xlarge "/>
						<input id="wx_file_select_button" type="button" value="选择图片"/>
				...
				<div class="control-group" id="wx_ad_url">
					<label class="control-label">微信链接地址：</label>
					<div class="controls">
						<form:input path="wxUrl" htmlEscape="false" maxlength="255" class="input-xlarge "/>
					</div>
				</div>
			</c:otherwise>
		</c:choose>
