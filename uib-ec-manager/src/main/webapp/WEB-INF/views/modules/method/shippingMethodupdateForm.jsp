...
<body>
	...
	<form:form id="inputForm" modelAttribute="shippingMethod" action="${ctx}/method/shippingMethod/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">默认物流公司：</label>
			<div class="controls">
				<select id="defaultdeliverycorp" name="defaultdeliverycorp" data-value="{{row.orderShipping}}" class="input-small ">
