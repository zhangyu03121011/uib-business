...
<body>
	...
	<form:form id="inputForm" modelAttribute="paymentMethod" action="${ctx}/method/paymentMethod/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="description" htmlEscape="false" maxlength="255" class="input "/>
			</div>
		</div>
		<div class="control-group">
