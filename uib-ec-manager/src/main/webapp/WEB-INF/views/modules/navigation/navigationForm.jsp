...
<body>
	...
	<form:form id="inputForm" modelAttribute="navigation" action="${ctx}/navigation/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:radiobutton path="isBlankTarget" value="0" checked="checked"/>否
			</div>
		</div>
		<div class="control-group">
