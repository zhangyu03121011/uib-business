...
<body>
	...
	<form:form id="inputForm" modelAttribute="memRank" action="${ctx}/mem/memRank/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<%-- <div class="control-group">
			...
			<div class="controls">
				<input type="radio" name="isSpecial"  value="0" checked="checked">否
				<input type="radio" name="isSpecial"  value="1">是
			</div>
		</div> --%>
		<%-- <div class="control-group">
