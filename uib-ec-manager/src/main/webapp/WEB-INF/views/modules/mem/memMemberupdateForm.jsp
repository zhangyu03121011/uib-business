...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/mem/memMember/form?id=${memMember.id}">会员<shiro:hasPermission name="mem:memMember:edit">${not empty memMember.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="mem:memMember:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memMember" action="${ctx}/mem/memMember/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">锁定日期：</label>
			<div class="controls">
				<input name="lockedDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${memMember.lockedDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="isLocked" class="input-xlarge required">
					<form:option value="" label=""/>
