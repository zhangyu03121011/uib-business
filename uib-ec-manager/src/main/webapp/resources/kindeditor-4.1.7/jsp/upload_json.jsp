...
//文件请求URL
//String saveUrl  = request.getContextPath() + "/a/";
String saveUrl  =  "";
//定义允许上传的文件扩展名
...
while (itr.hasNext()) {
	...
	if (!item.isFormField()) {
		...
		String newFileName = df.format(new Date()) + "_" + fileExt +"_" + new Random().nextInt(1000) +"." + fileExt;
		try{
		...
		obj.put("error", 0);
		//System.out.println("savePath222 ===" + savePath);
		//System.out.println("newFileName ===" + newFileName);
		//obj.put("url", savePath + newFileName);
		obj.put("url", frontWebUrl+ dirName + "/" + newFileName);
		out.println(obj.toJSONString());
		System.out.println(frontWebUrl+ dirName + "/" + newFileName);
	}
}
%>
<%!
