 ...
 */
package com.uib.ecmanager.modules.cms.web;
...
import com.uib.ecmanager.modules.cms.service.FileTplService;
import com.uib.ecmanager.modules.cms.service.SiteService;
import com.uib.ecmanager.modules.cms.utils.TplUtils;
...
public class CategoryController extends BaseController {
	...
	@RequiresPermissions("cms:category:edit")
	@ResponseBody
	@RequestMapping(value = "checkCmsCategoryNo")
	public ReturnMsg<Object> checkMerchantName(String cmsCategoryNo, RedirectAttributes redirectAttributes) {
		ReturnMsg<Object> returnMsg = new ReturnMsg<Object>();
		Category category  = new Category();
		List<Category> categorys = categoryService.findCmsCategory(category);
		for (Category category1 : categorys) {
			String CategoryNo = category1.getCmsCategoryNo();
			if(CategoryNo.equals(cmsCategoryNo)){
				returnMsg.setMsg("已经添加");
				returnMsg.setStatus(false);
				return returnMsg;
			}else{
				returnMsg.setMsg("可以添加");
