...
import com.uib.ecmanager.common.security.Digests;
import com.uib.ecmanager.common.security.shiro.session.SessionDAO;
import com.uib.ecmanager.common.service.BaseService;
import com.uib.ecmanager.common.service.ServiceException;
import com.uib.ecmanager.common.utils.CacheUtils;
import com.uib.ecmanager.common.utils.Encodes;
import com.uib.ecmanager.common.utils.StringUtils;
import com.uib.ecmanager.modules.sys.dao.MenuDao;
import com.uib.ecmanager.modules.sys.dao.RoleDao;
...
import com.uib.ecmanager.modules.sys.security.SystemAuthorizingRealm;
import com.uib.ecmanager.modules.sys.security.SystemAuthorizingRealm.Principal;
import com.uib.ecmanager.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://uib_ec.com\r\n");
		sb.append("\r\n======================================================================\r\n");
	...
	public User getCurrent() {
		...
		if (subject != null) {
			...
			if (principal != null) {
				return userDao.get(principal.getId());
			}
		}
		return null;
	}
	...
	@Transactional(readOnly = false)
	public UserMerchantMap getUserMerchantMap(String merchantNo){
		if(merchantNo!=null){
			return userMerchantMapDao.getMapByMerchantNo(merchantNo);
		}
		return null;
	}
	@Transactional(readOnly = false)
	public UserMerchantMap getMerchantMap(String userId){
		if(userId!=null){
			return userMerchantMapDao.getMapByUserId(userId);
		}
		return null;    
	}
