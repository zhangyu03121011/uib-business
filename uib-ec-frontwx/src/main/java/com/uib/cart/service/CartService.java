...
public interface CartService {
	 ...
	 * @return
	 */
	public Map<String,Object> queryCartByUserName(String userName) throws Exception;
	
	public Map<String,Object> queryCartItemByUserNameAndProductId(String userName,String productId) throws Exception;
